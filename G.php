...
<div class="body">
  ...
  <div class="header" >
    ...
    <div class="group_Menu ">
      <!-- Left Menu -->       
                  <div class="left_Menu">
                  <ul >  
                      <li style="width: 100%;padding-left: 10px;"><a href="MainFile.php"><i style="padding:2px;" class="fa-solid fa-desktop"></i>ផ្ទាំងគ្រប់គ្រងទូទៅ</a></li>               
                      <li>  
                          <a href="#">                      
  ...
  <div class="nameData p-0 align-items-center" >
    ...
    <div class="groupDetail  d-flex justify-content-center align-items-center">
        <div  class="detail text-decoration-none"> 
           <a href="#" style='color:red'>ផ្ទាំងគ្រប់គ្រងទូទៅ</a>
    ...
    <div class="changeData " style="padding-right:12px">
      <a style='color:red'>example@gmail.com</a>
    </div>
...
<section style="background-color: lightgray" class="Group_Data section2  p-3 ">
    <div style="height:89vh;width:100%;"  class="group_block p-2 bg-light rounded-3 ">
    </div>
