    ...
    <div class="groupDetail  d-flex justify-content-center align-items-center">
        <div  class="detail text-decoration-none"> 
           <a href="">ទំព័រដើម</a> <span>/</span>
            <a href="" style="color:red">អតិថិជន</a><span>/</span>
    ...
    <div style="height:89vh;width: 100%;" class="group_block p-2 bg-light rounded-3 d-block">
      ...
      <div style="width: 50%;float:right;">
        ...
        <div style="float: right;padding-right:20px;" class="control_box">
          <button type="button" ><a href="G_Customer.php" style="color:white">រក្សាទុក​ & បិទ</a></button>
          <button type="button" ><a href="G_Customer_Add.php" style="color:white">រក្សាទុក​ & ថ្មី</a></button>
          <button type="button" ><a href="G_Customer.php" style="color:white">បោះបង់</a></button>
